...
/*   Updated: 2022/08/07 15:33:59 by lasalmi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_target	ft_count_target(int member, int i, int stack_size);
int		ft_total_cost_smaller(size_t total_cost, \
int b_value, int i, t_utils utils);
size_t	ft_total_cost_move(t_target target_a, t_target target_b);
