...
PUSH_SWAP_FILES = push_swap_main.c	chunks.c sandbox.c target.c costs.c instructions.c solver.c solver_utils.c solver_small.c preliminary.c finders.c presort.c
